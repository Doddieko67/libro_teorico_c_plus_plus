# Libro: C++ - Enfoques Teóricos

## Descripción
Libro profesional sobre C++ con enfoque teórico, cubriendo fundamentos y conceptos avanzados.

## Tecnologías utilizadas
- LaTeX (escritura)
- Texpresso (compilación en tiempo real)
- Mermaid (diagramas)
- Nvim (editor)
